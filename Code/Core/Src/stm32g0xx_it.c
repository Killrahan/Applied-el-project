...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
static uint8_t dac_index = 0; // Used to cycle through the table
/* USER CODE END PV */
...
extern uint8_t square_table[TABLE_SIZE];
extern uint8_t triangle_table[TABLE_SIZE];

extern volatile WaveformType current_waveform;
/* USER CODE END EV */
